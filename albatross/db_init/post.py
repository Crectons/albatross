...
postinfo_set = PostInfo.objects.filter(salary_type=2)

for item in postinfo_set:
    item.salary_min = item.salary_min // 1000 * 1000
    item.salary_max = item.salary_max // 1000 * 1000
    item.save()
